  ...
  fluidPage(
    ...
    fluidRow(
      box(
        ...
        width = 12, status = "primary", solidHeader = TRUE,
        radioButtons("botao_POA_heat",label="",choices = c("Todos os estabelecimentos","Sem considerar POA"),width = "100%",inline = TRUE),
    ...
    fluidRow(
      box(
        ...
        width = 12, status = "primary", solidHeader = TRUE,
        radioButtons("botao_POA_barra",label="",choices = c("Todos os estabelecimentos","Sem considerar POA"),width = "100%",inline = TRUE),
